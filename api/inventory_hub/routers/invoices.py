...
def invoices_refresh(
    ...
    lc = LoginConfig(
        ...
        user_field=login.user_field or "login",
        pass_field=login.pass_field or "password",
        username=login.username or "",
        password=login.password or "",
        cookie=login.cookie or "",
        insecure_all=bool(login.insecure_all),
    )
    mb = int(months_back or cfg.invoices.months_back_default or 3)
