    ...
    <Boundary>
      <div className="min-h-screen bg-slate-950 text-white">
        ...
        <main className="mx-auto max-w-6xl px-4 py-6 space-y-6">
          <Collapsible title="Configs" defaultOpen={false}>
            <ConfigPage shop={shop} supplier={supplier} />
          </Collapsible>          
          <Section title="Ovládanie">
            ...
            <RefreshInvoicesButton supplier={supplier} shop={shop} defaultMonths={3} />
          ...
          <section className="space-y-3">
            ...
            <InvoicesIndex supplier={supplier} shop={shop} />
          </section>
