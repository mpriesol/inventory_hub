...
| `013_receiving_scan_requests.sql` | Atómové potvrdenia UUID skenov a rozšírenie compound EAN riadka na 255 znakov. Obnovuje iba odvodený fingerprint, v transakcii bez CASCADE; nemení pohyby ani nastavenia. |
