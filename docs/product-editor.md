...
4. Počet riadkov na stránku je 25, 50 alebo 100. Usporiadanie môže byť podľa lokálnej rodiny a variantu, SKU alebo názvu. Číselné časti variantov/SKU sa radia prirodzene, napríklad 2 pred 10.
...
Niektoré polia, napríklad interná poznámka, DPH a poznámka variantu, sú predvolene skryté. Zapnete ich cez výber stĺpcov. SKU, EAN, dodávateľské kódy, variantné atribúty a skladové množstvá sú v tabuľke iba na čítanie. Nákupná cena je odvodená zo skladu; jej zmena patrí do kontrolovaného [FIFO postupu](fifo.md).
