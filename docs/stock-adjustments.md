...
- Pohyb, nákupná vrstva alebo alokácia výdaja, bilancia a uložený výsledok sa zapisujú v jednej transakcii. Interné služby `fifo` ostávajú spoločnou implementáciou oceňovania.
