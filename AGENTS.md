...
Run the relevant UI interaction checks above for changed workflows; CI runs all fourteen suites. They use jsdom and do not verify browser layout. Use browser inspection for material layout changes when available, and state any limitation.
